package com.example.google_ai.output;
...
public class ActorController {
    ...
    public ActorFilms getActorFilms(){
        return chatClient.prompt()
                .user("can you explain how USA got involved in world war2")
...
record ActorFilms(String actor,String names, List<String> movies) {
}
